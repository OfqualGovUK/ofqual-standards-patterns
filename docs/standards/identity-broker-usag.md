...
- [Use an identity broker for authentication and authorisation](#)


### Use an identity broker for authentication and authorisation
An Identity Broker MUST be used to federate the multiple identity providers and provide a single authentication and authorisation point to back-end services. 
