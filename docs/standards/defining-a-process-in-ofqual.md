...
id: OFQ-00021 # Set unique ID for standard
    ...
    - title: Related Principles
      items:
        - text: We design and continuously develop services that are durable and resilient
          href: /principles/We-design-and-continuously-develop-services/ # Note: use an absolute link from the site home page
---
...
- [Use BPMN 2.0 for process mapping](#use-bpmn-2-0-for-process-mapping)
...
All in‑scope processes must include, at a minimum:
